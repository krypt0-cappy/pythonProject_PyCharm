...
list_one = ["Hosting", "Leaseweb", "TechTruce", "One_Big_Company", "Digital_Potion", "ServerMania_Data_Centre",
            "Above_Host", "Locomotion_Creative",
            "Platform_Twenty_Ltd", "Appy_Monkey", "Cinnamon_Entertainment_Group", "The_Mobile_App_Developers",
            "Out_of_House", "Hostezza", "AristoMedia", "Bridge_Fibre",
            "HOSTGAI", "Plug_&_Play Web_Design", "PrimeXeon_Limited", "Simple_Design_Websites", "Brighter", "Stax",
            "Weeb_Digital", "Stanton_Shallcross", "Clarity_CB1"]
...
def ec2name():
    for item in range(num):
        ...
        combined = ''.join(random.sample(together,
                                         len(together)))  # list converted into a string with all characters merged together & shuffled
        print(item + combined)
